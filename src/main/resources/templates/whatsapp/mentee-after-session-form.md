# Mentee After Session Form WhatsApp Template

Template name: `prosper_mentee_after_session_form`
...
- This template is used when the mentee is asked to rate the mentor after a completed session.
